...
public class AdminUcmformTest extends BaseClass{
	...
	public void adminsubformcreation(String testdesc, String tn, String co, String gn, String ct1, String ct2, String cs) throws Exception {
		...
		if (testdesc.equals("validdata")) {
			ucmformpage.ucmForm(tn,co,gn, ct1, ct2,cs);
