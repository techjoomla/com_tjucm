...
<form action="<?php echo JRoute::_('index.php?option=com_tjucm&view=items'); ?>" method="post"
	...
	<?php if ($canCreate) : ?>
		<a href="<?php echo JRoute::_('index.php?option=com_tjucm&task=itemform.edit&id=0', false, 2); ?>"
		   class="btn btn-success btn-small"><i
				class="icon-plus"></i>
			<?php echo JText::_('COM_TJUCM_ADD_ITEM'); ?></a>
	<?php endif; ?>
